                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 flex space-x-2">
                            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2" 
